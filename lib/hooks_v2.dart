  ...
  LanguageHook getLanguageCodeAndName() {
    LanguageHook languageHook = () {
      ...
      Map<String, dynamic> yourLanguageMap = {
        ...
        "languageCodeForURL": "YOUR-LANGUAGE-CODE-FOR-URL" // Optional (Specify your language code for URL)
...
@override
  EditProfileShowFieldHook getEditProfileShowFieldHook() {
    EditProfileShowFieldHook editProfileShowFieldHook = (String fieldName) {
      /// If you want to show/hide any field in edit profile page, use this method.
      ///
      /// If you want to show the field, return true, otherwise return false to hide the field.
      ///
      /// These name are default for all field
      // if (fieldName == "facebook") {
        // return false; // Show facebook field
      // }
      // else if(fieldName == "phone") {
      //   return false; // Show phone field
      // }
      ...
      //   return true; // Show title_position field
      // }else if(fieldName == "tax_number"){
      //   return false; // Hide tax_number field
  ...
  CustomCountryHook getCustomCountryHook() {
    CustomCountryHook customCountryHook = () {
      /// Hook to customize the country calling code in phone field.
      /// Add this in List<Country> to show specific countries in phone field.
      /// If you want to show all countries by default, return null.
      /// 
      /// Country(code: "PK", dialCode: "92", name: "Pakistan", flag: '🇵🇰', nameTranslations: {}, minLength: 10, maxLength: 10,),
      /// 
      /// "code" needs 2 letter ISO code, "PK" for Pakistan, "US" for USA, "RU" for Russia etc.
      /// 
      /// "dialCode" needs the country code, "92" for Pakistan, "1" for USA, "7" for Russia etc.
      /// 
      /// "name" needs the country name, "Pakistan", "USA", "Russia" etc.
      /// 
      /// "flag" needs the country flag, '🇵🇰' for Pakistan, '🇺🇸' for USA, '🇷🇺' for Russia etc. 
      /// 
      /// Note This is invalid PK flag, '🇵🇰' is valid. remember to use Regional Indicator Symbols or Add Flag from Icons
      /// On Mac
      // Press Control + Command + Space to open the emoji picker.
      // Search: "Pakistan" → Click 🇵🇰
      ///
      // On Windows
      // Press Windows + . (Windows + period) to open emoji panel.
      ...
      // return countryList;  // if you want to use specific countries, return this list
      return null; // if you want to use all countries by default, return null
    };
  ...
  /// This method is used to set the background image of the home sliver app bar.
  /// If you want to set the background image, return the image path.
  /// If you don't want to set the background image, return null.
  /// The image path should be in the assets folder and should be added in.
   @override
  HomeSliverAppBarBGImageHook getHomeSliverAppBarBGImageHook() {
    return (BuildContext context) {
      ...
      return null; // If you don't want to use background image, return null
    };
  }
  ...
  HomeSliverAppBarBodyHook getHomeSliverAppBarBodyHook() {
    HomeSliverAppBarBodyHook _homeSliverAppBarBodyHook = (context) {
      ...
      Widget? _bodyWidget;
      // String? _backgroundImage; // Uncomment this line if you want to set background image

      // _bodyWidgetHeight = 220;
      // _bodyWidget = HomeSliverAppBarBodyWidget();
      // _backgroundImage: "assets/image/any_image.png";
      // _backgroundImage = "assets/settings/dummy_property_image_01.jpg";

      _bodyHookMap = {
        "height": _bodyWidgetHeight,
        "widget": _bodyWidget,
        // "background_image": _backgroundImage, //Uncomment this line as well if you want to set background image
        };
      return _bodyHookMap;
    };
