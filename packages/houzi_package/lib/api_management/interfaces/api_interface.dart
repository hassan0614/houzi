...
abstract class WebsiteApiServices {
  ...
  ApiRequest provideUsersInsights({String? timePeriod,int? propertyId});
  ApiRequest providePropertyInsights({int? propertyId,String? timePeriod, String? dataType});
  ApiRequest provideAllUsersApiV2(int page, int perPage, String search, String approvalStatus);
