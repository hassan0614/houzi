...
const String HOUZI_VERSION = "1.4.5";
...
const String EXCHANGE_RATE_CURRENCY_DATA = "currency_rates";
const String SELECTED_CURRENCY_DATA = "selected_currency";
...
const String PROPERTY_CURRENCY = "currency";
...
const USER_SOCIAL_USER_NAME = "username";
...
const NEW_PASSWORD_KEY = "newpass";
const CONFIRM_PASSWORD_KEY = "confirmpass";

/// STORAGE Keys:
const String PROPERTY_META_DATA = 'PropertyMetaData';
const String SCHEDULE_TIME_SLOTS = 'ScheduleTimeSlots';
const String NEW_RATING_APPROVED_BY_ADMIN_METADATA = 'NewRatingApprovedByAdmin';
const String IS_USER_ADMIN = 'isUserAdmin';
...
const String INSIGHT_VIEWS_METADATA = 'InsightViewsMetaDataList';
const String INSIGHT_UNIQUE_VIEWS_METADATA = 'InsightUniqueViewsMetaData';
const String INSIGHT_COUNTRY_METADATA = 'InsightcountryMetaData';
const String INSIGHT_DEVICES_METADATA = 'InsightDevicesMetaData';
const String INSIGHT_PLATFORM_METADATA = 'InsightPlatformMetaData';
const String INSIGHT_BROWSERS_METADATA = 'InsightBrowserMetaData';
...
const String MULTI_CURRENCY_ENABLED_STATUS = 'multi_currency_enabled';
...
const String HOME_LOCATION_SEARCH_INFO_KEY = 'home_location_search_info';
const String HOME_CUSTOM_SEARCH_INFO_KEY = 'home_custom_search_info';
const String APPROVAL_STATUSES_LIST_KEY = 'approval_statuses_list_key';
const String IS_APPROVAL_STATUS_ENABLED_KEY = 'is_approval_status_enabled_key';
...
const String CURRENCY_SWITCHER = 'currency_switcher';
...
const String USER_ROLE_AGENT_VALUE = 'houzez_agent';
const String USER_ROLE_AGENCY_VALUE = 'houzez_agency';
const String USER_ROLE_OWNER_VALUE = 'houzez_owner';
const String USER_ROLE_BUYER_VALUE = 'houzez_buyer';
const String USER_ROLE_SELLER_VALUE = 'houzez_seller';
const String USER_ROLE_MANAGER_VALUE = 'houzez_manager';
const String USER_ROLE_AUTHOR_VALUE = 'houzez_author';

const String USER_ROLE_AGENT_OPTION = 'Agent';
const String USER_ROLE_AGENCY_OPTION = 'Agency';
const String USER_ROLE_OWNER_OPTION = 'Owner';
const String USER_ROLE_BUYER_OPTION = 'Buyer';
const String USER_ROLE_SELLER_OPTION = 'Seller';
const String USER_ROLE_MANAGER_OPTION = 'Manager';
...
const String PROPERTY_DETAILS_PROPERTY_ROOMS = 'Rooms';
...
const String INQUIRY_ROOMS = "e_meta[rooms]";
...
/// Home screen design related hooks keys
const String SET_Background_Image = "background_image";
...
const String AB_MAP_PRICE = "Property_Map_Price";
...
const String OPTION_PUBLISH = "approve";
const String OPTION_REJECT = "reject";
const String OPTION_REVIEW_DELETE = "delete";
...
const String enableHtmlInBlogDescriptionConfig =
    "enable_html_in_blog_description";

const String showMessageButtonConfiguration = "show_message_button";

const String selectedItemBackgroundColorDarkModeConfiguration =
    "selected_item_background_color_dark_mode";
const String selectedItemTextColorDarkModeConfiguration =
    "selected_item_text_color_dark_mode";
const String unSelectedItemTextColorDarkModeConfiguration =
    "un_selected_item_text_color_dark_mode";
const String unSelectedItemBackgroundColorDarkModeConfiguration =
    "un_selected_item_background_color_dark_mode";
...
const String stringPickerRoomsKey = "rooms";
...
const String propertyMultiCurrencyDataType = "multi_currency";
...
const String newRatingsApprovedByAdminKey = "new_ratings_approved_by_admin";
const String isUserAdminKey = "is_user_admin";
const String defaultCurrencyKey = "default_currency";
const String currencySwitchEnabledKey = "currency_switcher_enabled";
const String userRolesKey = "user_roles";
const String allUserRolesKey = "all_user_roles";
const String defaultCurrencySymbolKey = "default_currency_symbol";
...
const String SEARCH_RESULTS_ROOMS = "rooms";
...
const String tempRealtorVerificationKey = "tempRealtorVerification";
...
const defaultLangOnUrlAndSecondaryLangAsDirectory =
    "default_lang_on_default_url_and_secondary_lang_as_directory";
...
const String favPropertyRoomsKey = "fave_property_rooms";
...
const String SAVE_SEARCH_ROOMS = "rooms";
...
const int FeaturedPropertiesPerPageListings = 16;
const int LatestPropertiesPerPageListings = 16;
const int SearchPropertiesPerPageListings = 20;

/// Form Param Related Keys
const String AgentIdKey = "agent_id";
const String TargetEmailKey = "target_email";
...
const String AgentTypeKey = "agent_type";
const String PropertyIdKey = "property_id";
const String ListingIdKey = "listing_id";
const String PropertyTitleKey = "property_title";
const String PermaLinkKey = "perma_link";
const String SourceLinkKey = "source_link";
const String SourceKey = "source";
const String WebsiteKey = "website";
const String ScheduleTourTypeKey = "schedule_tour_type";
const String ScheduleTimeKey = "schedule_time";
const String ScheduleDateKey = "schedule_date";
const String ReasonKey = "reason";
const String ContentIdKey = "content_id";
const String ContentTypeKey = "content_type";

const String UserNameKey = 'username';
const String UserEmailKey = 'useremail';
const String TermConditionKey = 'term_condition';
...
const String RegisterPasswordKey = 'register_pass';
const String RetypeRegisterPasswordKey = 'register_pass_retype';
const String UserLoginKey = 'user_login';
const String PageKey = 'page';
const String PerPageKey = 'per_page';
const String StatusKey = "status";
const String AddedKey = "added";
const String RemovedKey = "removed";
const String ThumbIdKey = 'thumb_id';
const String IdKey = 'id';
const String UpdateUserProfileImagePathKey = 'imagepath';
const String PrintPropertyPDFKey = 'propid';

const String InAppPurchaseKey = 'iap';
const String InAppPurchaseResponseKey = 'iap_response';
const String InAppPurchasePackageIdKey = 'pack_id';
const String InAppPurchasePropertyIdKey = 'prop_id';
const String InAppPurchasePropertyFeaturedKey = 'is_prop_featured';

const String InAppPurchaseGooglePlayKey = 'GooglePlay';
const String InAppPurchaseAppStoreKey = 'AppStore';

const String MakeFeaturedListingPropertyIdKey = 'propid';
const String MakeFeaturedListingPropertyTypeKey = 'prop_type';

const String RemoveFromFeaturedPropertyIdKey = 'propid';
const String ActionKey = "action";

const String SoldStatusKey = "houzez_sold";
const String ExpiredStatusCapsKey = "EXPIRED";

const String ThreadIdKey = "threadId";
const String SenderIdKey = "senderId";
const String ReceiverIdKey = "receiverId";
const String SeenKey = "seen";
const String ThreadPageKey = "page";
const String ThreadPerPageKey = "perPage";

/// API Tags
const String FeaturedListingTag = "featured listings";
const String LatestListingTag = "latest listings";
const String FilteredListingTag = "filtered listings";
const String SimilarListingTag = "similar listings";
const String MultipleListingTag = "multiple listings";
const String SingleListingTag = "single listing";
const String MultiCurrenciesTag = "multi currencies";
const String SingleListingViaPermaLinkTag = "single listing via perma-link";
const String TouchBaseInfoTag = "touch-base";
const String SingleAgencyTag = "single agency";
const String SingleAgentTag = "single agent";
const String AgentsOfAgencyInfoTag = "agents of an agency";
const String AllAgentsTag = "all agents";
const String AllAgenciesTag = "all agencies";
const String ListingByCityTag = "listings by city";
const String ContactRealtorTag = "contact realtor";
const String ContactDeveloperTag = "contact developer";
const String ScheduleATourTag = "schedule a tour";
const String AddNewListingTag = "add new listing";
const String UpdateListingTag = "update listing";
const String LoginTag = "login";
const String SignUpTag = "sign-up";
const String AdminUserSignUpTag = "admin-user-sign-up";
const String ForgotPasswordTag = "forgot password";
const String AllPropertiesListingTag = "all properties listing";
const String MyListingTag = "my listings";
const String StatusOfPropertyTag = "status of Property";
const String DeleteListingTag = "delete listing";
const String TermDataTag = "term data";
const String AddOrRemoveFromFavoritesTag = "add or remove from favorites";
const String SearchAgenciesTag = "search agencies";
const String FavoriteListingsTag = "favorite listings";
const String DeleteImageTag = "delete image while updating listing";
const String SaveSearchTag = "save search";
const String SavedSearchesListingTag = "saved searches listing";
const String DeleteSavedSearchTag = "delete saved search";
const String AddReviewTag = "add review";
const String ReportContentTag = "report content";
const String ListingReviewsTag = "listing reviews";
const String RealtorReviewsTag = "realtor reviews";
const String UserInfoTag = "user info";
const String FetchAllReviewsTag = "fetch all reviews";
const String UpdateUserProfileTag = "update user profile";
const String FixProfileImageTag = "fix profile image";
const String UpdateUserProfileImageTag = "update user profile image";
const String SearchAgentsTag = "search agents";
const String IsFavoriteListingTag = "is favorite Listing";
const String SocialSignOnTag = "social sign-on";
const String DeleteUserAccountTag = "delete user account";
const String UpdatePasswordTag = "update password";
const String RequestPropertyTag = "request property";
const String AddAgentTag = "add agent";
const String EditAgentTag = "edit agent";
const String AllAgentsOfAnAgencyTag = "all agent of an agency";
const String DeleteAnAgentTag = "delete an agent";
const String AllUsersTag = "all users";
const String AllUserV2Tag = "all user v2";
const String AllUsersPropertiesTag = "All Properties";
const String InsightPropertiesTag = "insight properties";
const String UsersInsightTag = "insight Users";
const String UserReviewsSettingTag = "user reviews setting";
const String UserApprovalStatusesListTag = "approval statuses list";
const String UserApprovalTag = "user approval action";
const String ReviewApprovalTag = "review approval action";
const String UserPaymentStatusTag = "user payment status";
const String AllPartnersTag = "all partners";
const String MembershipPackagesTag = "membership packages";
const String UserMembershipPackageTag = "user membership package";
const String ProceedWithPaymentsTag = "proceed with payments";
const String MakePropertyFeaturedTag = "make property featured";
const String RemoveFromFeaturedTag = "remove from featured";
const String ApproveOrDisapproveListingTag = "approve or disapprove listing";
const String ToggleFeaturedTag = "toggle featured";
const String SetSoldStatusTag = "set sold status";
const String SetExpireStatusTag = "set expire status";
const String SetPendingStatusTag = "set pending status";
const String AllBlogsTag = "all blogs";
const String AllBlogCategoriesTag = "all blog categories";
const String AllBlogTagsTag = "all blog tags";
const String BlogCommentsTag = "blog comments";
const String AddBlogCommentTag = "add blog comment";
const String AllNotificationsTag = "all notifications";
const String CheckNotificationsTag = "check notifications";
const String DeleteNotificationsTag = "delete notifications";
const String AllThreadsTag = "all threads";
const String AllMessagesTag = "all messages";
const String DeleteThreadTag = "delete thread";
const String StartThreadTag = "start thread";
const String SendMessageTag = "send message";
const String CreateNonceTag = "create nonce";

const String CRMActivitiesTag = "CRM activities";
const String CRMLeadsTag = "CRM leads";
const String CRMActivityDealsTag = "CRM activity deals";
const String CRMBoardLeadsTag = "CRM board leads";
const String CRMInquiriesTag = "CRM inquiries";
const String CRMInquiryMatchedTag = "CRM inquiry matched";
const String CRMInquiryNotesTag = "CRM inquiry notes";
const String CRMLeadInquiriesTag = "CRM lead inquiries";
const String CRMLeadDetailsTag = "CRM lead details";
const String CRMLeadViewedTag = "CRM lead viewed";
const String CRMLeadNotesTag = "CRM lead notes";
const String CRMAddInquiryTag = "CRM add inquiry";
const String CRMDeleteInquiryTag = "CRM delete inquiry";
const String CRMGetLeadsTag = "CRM get leads";
const String CRMAddLeadTag = "CRM add lead";
const String CRMGetDealsTag = "CRM get deals";
const String CRMAddDealTag = "CRM add deal";
const String CRMDeleteDealsTag = "CRM delete deals";
const String CRMAddInquiryNotesTag = "CRM add inquiry notes";
const String CRMUpdateDealDetailsTag = "CRM update deal detail";
const String CRMSendEmailTag = "CRM send email";
const String CRMDeleteNotesTag = "CRM delete notes";
const String CRMDeleteLeadTag = "CRM delete lead";
const String CRMSocialSignOnTag = "CRM social sign-on";

/// User Approval Status
const String USER_APPROVAL_STATUS_APPROVED = "Approved";
...
const String INSIGHTS_LABEL_SORT_LAST_MONTH = "Last 30 Days";
...
const String INSIGHTS_VALUE_SORT_LAST_7_DAYS = "lastweek";
const String INSIGHTS_VALUE_SORT_LAST_30_DAYS = "lastmonth";
...
const List<String> USER_REVIEWS_FILTER_LIST = [
  ...
  REVIEW_APPROVAL_ACTIONS_REVIEW_REJECT,
  REVIEW_APPROVAL_STATUS_PENDING,
];
