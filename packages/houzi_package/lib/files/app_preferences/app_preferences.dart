...
class AppThemePreferences{
  ...
  ///
  /// Filter Dialog Background Color:
  static Color filterDialogBackgroundColor = Colors.black54;
  ///
  /// User Status is Approved Color:
  static Color userStatusApprovedColor = const Color(0xFF39CD00);
  
  ///
  /// Link Color:
  static Color linkColor = appSecondaryColor;
  ///
  /// User Is Not Approved (Declined, Suspended, Pending) Color:
  static Color? userStatusNotApprovedColor = Colors.red[700];
  ///
  /// Error Color:
  ...
  ///
  /// Cancel Button Background color
  static Color realtorverificationTagColor = Colors.white;
  ///
  ...
  ///
  /// Insights Visits Color
  static Color insightsVisitsColor = Colors.pink;
  ///
  /// Insights Unique Visits Color
  static Color insightsUniqueVisitsColor =  Colors.blue;
  ///
  /// Bottom Tab Bar Tint Color
  ...
  ///
  /// Light Color for Trending Up Card
  static Color trendingUpCardLightColor = const Color(0xFFddf1f0);
  ///
  /// Light Colors for Trending Down Card
  static Color trendingDownCardLightColor = const Color(0xFFfde7e9);
  ///
  /// Dark Mode Colors:
  ///
  ///
  ...
  ///
  /// Agent Agency Verifid Icon color
  static Color agentAgencyVerifiedIconColorDark = Colors.green;
  ///
  /// Realtor Agency/Agents Verified color
  static Color realtorVerificationColor = Colors.green;
  ///
  /// Trending Up Icon color
  static Color trendingUpIconColor = Colors.green;  
  /// Trending Down Icon color
  static Color trendingDownIconColor = Colors.red;
  /// 
  /// realtor verified Icon color Light
  static Color? agentAgencyUnverifiedIconColor = Colors.white;
  ///
  /// Agent Agency Unverified Icon color Dark
  static Color? agentAgencyUnverifiedIconColorLight = Colors.grey[600];
  ///
  /// Property Details Page Image Indicator Text color
  ...
  ///
  /// Trending Up Card Dark Color
  static Color trendingUpCardDarkColor = const Color(0xFF1E3A39);
  ///
  /// Trending Down Card Dark Color
  static Color trendingDownCardDarkColor = const Color(0xFF5C2B33);
  ///
  ///
  /// Icons:
  ///
  ...
  static double agentAgencyVerifiedIconSize = 18.0;
  static double agentAgencyUnverifiedIconSize = 12.0;
  static double propertyDetailsChipsIconSize = 20.0;
  static double trendingUpIconSize = 20.0;
  static double trendingDownIconSize = 20.0;
  ...
  static double insightsCardIconSize = 15.0;
  ...
  ///
  /// Room Icon
  static IconData roomIcon = Icons.meeting_room_outlined;
  ///
  /// Bathtub Icon
  ...
  ///
  /// Agent/Agency Verified Icon
  static IconData agentAgencyVerificationIcon = Icons.verified;
  ///
  /// Agent/Agency Non-Verified Icon
  static IconData realtorVerificationIcon = Icons.verified_outlined;
  ///
  /// Saved Searches Icon
  ...
  ///
  /// Insighs Icon
  static IconData insightsIcon = Icons.insights_outlined;
  /// Add Icon
  static IconData allReviews = Icons.reviews_outlined;
  ///
  /// Membership Icon
  ...
  ///
  /// Currency Icon
  static IconData currencyIcon = Icons.currency_exchange;
  ///
  ...
  ///
  /// Circle Icon
  static IconData circleIcon = Icons.circle_outlined;
  ///
  /// Trending Up Icon
  static IconData trendingUpIcon = Icons.trending_up_outlined;
  ///
  /// Trending Down Icon
  static IconData trendingDownIcon = Icons.trending_down_outlined;
  ///
  /// Map Icon
  ...
  ///
  /// Declined Icon
  static IconData declinedIcon = Icons.cancel_outlined;
  ///
  /// Trash Icon
  static IconData trashIcon = Icons.delete_outline;
  ///
  /// Suspended Icon
  static IconData suspendedIcon = Icons.pause_circle_outline;
  ///
  /// Ads Click Icon
...
class AppTheme{
  ...
  AppTheme({this.isDark = false}) {
    ...
    _trendingUpCardColor = isDark ? AppThemePreferences.trendingUpCardDarkColor : AppThemePreferences.trendingUpCardLightColor;
    _trendingDownCardColor = isDark ? AppThemePreferences.trendingDownCardDarkColor : AppThemePreferences.trendingDownCardLightColor;
    /// icons:
    ...
    _realtorVerificatinIcon = Icon(AppThemePreferences.realtorVerificationIcon,  color: AppThemePreferences.agentAgencyUnverifiedIconColor, size: AppThemePreferences.agentAgencyUnverifiedIconSize);
    _trendingUpIcon = Icon(AppThemePreferences.trendingUpIcon, size: AppThemePreferences.trendingUpIconSize, color: AppThemePreferences.trendingUpIconColor);
    _trendingDownIcon = Icon(AppThemePreferences.trendingDownIcon, size: AppThemePreferences.trendingDownIconSize, color: AppThemePreferences.trendingDownIconColor);
  ...
  ///
  /// Trending Down Card Color
  Color? _trendingDownCardColor;
  Color? get trendingDownCardColor => _trendingDownCardColor;
  ///
  /// Trending Up Card Color
  Color? _trendingUpCardColor;
  Color? get trendingUpCardColor => _trendingUpCardColor;
  ///
  ///
  /// Icon:
  ///
  ...
  ///
  /// Article Box Room Icon
  Icon? _articleBoxRoomIcon;
  Icon? get articleBoxRoomIcon => _articleBoxRoomIcon;
  ///
  ...
  ///
  /// Agent/Agency Verified Icon
  Icon? _agentAgencyVerifiedIcon;
  Icon? get agentAgencyVerifiedIcon => _agentAgencyVerifiedIcon;
  ///
  /// Realtor Verification Icon for Realtor Info
  Icon? _realtorVerificatinIcon;
  Icon? get realtorVerificatinIcon => _realtorVerificatinIcon;
  ///
  /// Trending Up Icon for Rising Leads
  Icon? _trendingUpIcon;
  Icon? get trendingUpIcon => _trendingUpIcon;
  /// Trending Down Icon for Falling Leads
  Icon? _trendingDownIcon;
  Icon? get trendingDownIcon => _trendingDownIcon;
  ///
