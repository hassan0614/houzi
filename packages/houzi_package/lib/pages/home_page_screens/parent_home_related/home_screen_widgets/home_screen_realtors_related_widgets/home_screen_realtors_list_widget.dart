        ...
        itemBuilder: (context, index) {
          ...
          if (tag == AGENTS_TAG) {
            if(item is Agent) {
              ...
              checkVerification = item.agentVerification;
            }
          } else {
            if(item is Agency) {
              ...
              checkVerification = item.agencyVerification;
            }
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Column(
                            ...
                            CrossAxisAlignment.start,
                            children: [
                              RealtorNameWidget(title: item.title, tag: tag, isVerified: checkVerification),
                              if (tag == AGENTS_TAG && item is Agent) RealtorPositionWidget(position: "${item.agentPosition}"),
                              if (tag == AGENTS_TAG && item is Agent) RealtorNameWidget(title: "${item.agentCompany}",tag: tag, isVerified: item is Agency ? checkVerification : false),
