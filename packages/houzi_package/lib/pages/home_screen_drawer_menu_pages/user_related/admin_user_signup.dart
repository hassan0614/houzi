...
class AdminUserSignUpState extends State<AdminUserSignUp> with ValidationMixin {
  ...
  void initState() {
    ...
    print("User Role List: $userRoleList");
      ...
      onPressed: () async {
        ...
        if (formKey.currentState!.validate()) {
          ...
          Map<String, dynamic> _params = {
            ...
            UserEmailKey : email,
            RegisterPasswordKey : registerPass.text,
            RetypeRegisterPasswordKey : registerPassRetype.text,
          ...
          ApiResponse<String> response = await _apiManager.adminUserSignUp(_params, token, nonce);
          ...
          if (response.success && response.internet) {
            _showToastForUserLogin(context, response.message);
            ...
            _showToastForUserLogin(context, message);
          }
        }
      },
    );
