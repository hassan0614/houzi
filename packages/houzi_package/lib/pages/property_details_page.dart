...
class _PropertyDetailsPageState extends State<PropertyDetailsPage> {
  ...
  bool tempAgentVerified = false;
  bool isAgencyVerified = false;
    ...
    if (agentDisplayOption == AGENCY_INFO || agentDisplayOption == AGENT_INFO){
      ...
      _futureAgentOrAgencyInfo!.then((dataList) {
        if(dataList.isNotEmpty){
          ...
          bool verified = false;
          if (item is Agent) {
            verified = item.agentVerification;
          } else if (item is Agency) {
            verified = item.agencyVerification;
          }
          tempRealtorId = item.id;
          tempRealtorName = item.title ?? "";
          tempAgentVerified = verified;
          ...
          _realtorInfoMap = {
            ...
            tempRealtorVerificationKey : tempAgentVerified,
      ...
      if(realtorInfo != null) {
        ...
        tempAgentVerified = realtorInfo.isVerified ?? false;
