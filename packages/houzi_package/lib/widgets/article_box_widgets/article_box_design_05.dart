...
class ArticleDesign05FeaturesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String _rooms = infoDataMap[AB_ROOMS] ?? "";
  ...
  bool showRoomsPadding(String rooms, String area) {
    if (showFeature(rooms) && showFeature(area)) {
      return true;
    }
    return false;
  }
