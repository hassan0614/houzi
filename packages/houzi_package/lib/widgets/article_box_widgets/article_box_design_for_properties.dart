...
class PropertiesArticleBoxFeaturesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String _rooms = article.features!.rooms ?? "";
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          if (showFeature(_rooms) && SHOW_ROOMS_IN_PROPERTY_BOX)
            ArticleBox01FeaturesSubWidget(
              title: _rooms,
              icon: AppThemePreferences().appTheme.articleBoxRoomIcon!,
            ),
          if (showRoomsPadding(_rooms) && SHOW_ROOMS_IN_PROPERTY_BOX)
  ...
  bool showRoomsPadding(String rooms,) {
    if (showFeature(rooms)) {
      return true;
    }
    return false;
  }
