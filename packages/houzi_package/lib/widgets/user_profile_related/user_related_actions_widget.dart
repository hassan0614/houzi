...
import 'package:houzi_package/pages/home_screen_drawer_menu_pages/insights.dart';
              ...
              child: Column(
                children: [
                  ...
                  // && userRole == ROLE_ADMINISTRATOR
                    ...
                    GenericWidgetRow(
                      padding: const EdgeInsets.only(top: 20.0, bottom: 15.0),
                      iconData: AppThemePreferences.insightsIcon,
                      text: UtilityMethods.getLocalizedString("insights"),
                      removeDecoration: false,
                      onTap: () => onInsightsTap(context),),
                  if (SHOW_REVIEWS && userRole == ROLE_ADMINISTRATOR)
                    GenericWidgetRow(
                      padding: const EdgeInsets.only(top: 20.0, bottom: 15.0),
                      iconData: AppThemePreferences.allReviews,
                      text: UtilityMethods.getLocalizedString("Reviews"),
                      removeDecoration: true,
                      onTap: () => onAllReviewsTap(context),
                    ),
